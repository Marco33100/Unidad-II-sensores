...
MQTT_CLIENT_ID = "ESP32_A-M"
MQTT_TOPIC = "utng/mq6"
MQTT_PORT = 1883

# Configuración del MQ-06 (Sensor de Gas)
pin_mq06 = ADC(Pin(34))  # Conectar el MQ-06 al GPIO34 (entrada analógica)
pin_mq06.atten(ADC.ATTN_11DB)  # Configurar el rango de lectura (0-3.3V)
...
# Función para leer el valor del MQ-06
def leer_valor():
    return pin_mq06.read()  # Leer el valor analógico (0-4095)
...
while True:
    try:
        ...
        if ultimo_valor is None or abs(valor_actual - ultimo_valor) >= umbral_cambio:
            print(f"Valor MQ-06: {valor_actual}")
